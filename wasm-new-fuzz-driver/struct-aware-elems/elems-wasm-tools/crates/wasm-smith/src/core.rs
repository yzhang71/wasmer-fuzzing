...
impl Module {
    ...
    fn pre_fill_globals(&mut self) {
        ...
        let fill_globals = vec![GlobalType {val_type: ValType::F32,mutable: false,}, GlobalType {val_type: ValType::I32,mutable: true,}, GlobalType {val_type: ValType::V128,mutable: false,}];
    ...
    fn pre_fill_tables(&mut self) {
        ...
        let fill_tables = vec![TableType {element_type: RefType::FUNCREF, minimum: 1, maximum: Some(999),}, TableType {element_type: RefType::EXTERNREF, minimum: 500, maximum: Some(787),}, TableType {element_type: RefType::FUNCREF, minimum: 256, maximum: Some(478),}];
    ...
    fn pre_fill_memory(&mut self) {
        ...
        let fill_memory = vec![MemoryType {minimum: 0, maximum: Some(256), memory64: true, shared: false,}, MemoryType {minimum: 434, maximum: Some(987), memory64: false, shared: false,}, MemoryType {minimum: 256, maximum: Some(1024), memory64: true, shared: true,}];
    ...
    fn arbitrary_elems(&mut self, u: &mut Unstructured) -> Result<()> {
        ...
        arbitrary_loop(
            ...
            |u| {
                ...
                let kind = arbitrary_vec_u8(u)?;
                // let ty = arbitrary_vec_u8(u)?;
                let items = arbitrary_vec_u8(u)?;
